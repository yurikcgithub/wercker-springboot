...
<body>
    ...
    <div class="container">
      ...
      <div class="blueBannerHeading">
        <h1 class="blueBannerTitleWithSubtitle">
          <a style="color: #a00ff5">Oracle Container Cloud Service + Wercker + CHAD</a>
        </h1>
      </div>
  ...
  <div class="container serviceContainer" style="margin-top: 150px;">
    <div class="overviewLayout">
      <div>
              <br>SpringBoot application demo by yurikcgithub and yurikcdocker. Current server time: <%= new java.util.Date() %> <br>
              <br>
              <p>
